...
def channel_name(url: str) -> str:
    ...
    - :samp:`https://www.youtube.com/@{channel_name}/*`
    ...
    for pattern in patterns:
        ...
        if function_match:
            uri_style = function_match.group(1) or function_match.group(5)
            uri_identifier = function_match.group(2) or function_match.group(6)
